...
type UserLoaderConfig struct {
	...
	Fetch func(keys []int64) ([]*database.UserUser, []error)
...
type UserLoader struct {
	...
	cache map[int64]*database.UserUser
...
func (l *UserLoader) Load(key int64) (*database.UserUser, error) {
...
func (l *UserLoader) LoadThunk(key int64) func() (*database.UserUser, error) {
	l.mu.Lock()
...
func (l *UserLoader) LoadAll(keys []int64) ([]*database.UserUser, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserLoader) LoadAllThunk(keys []int64) func() ([]*database.UserUser, []error) {
	results := make([]func() (*database.UserUser, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserLoader) Prime(key int64, value *database.UserUser) bool {
	l.mu.Lock()
	var found bool
...
func (l *UserLoader) unsafeSet(key int64, value *database.UserUser) {
	if l.cache == nil {
		l.cache = map[int64]*database.UserUser{}
	}
	l.cache[key] = value
}
